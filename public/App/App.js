...
function coursInfoFullStack(){
  var frontend = document.getElementById("frontend")
  var rotatedImg6 = document.getElementById("more-info-course-img6")
  var courseFrontend = document.getElementById("course-frontend")
  rotatedImg6.classList.toggle("more-info-course-img-rotated6")
  frontend.classList.toggle("course-info-height-auto")
  courseFrontend.classList.toggle("course-frontend-open")
}
